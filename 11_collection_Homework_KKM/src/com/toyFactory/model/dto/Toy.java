...
public class Toy {
	...
	private String manifactureDate; // 제조일(문자열로 표현 - 20240925)
	private Set<String> materials; // 재료
	
	public Toy() {}
	
	
	public Toy(String name, int age, int price, String color, String manifactureDate, Set<String> materials) {
		super();
		this.name = name;
		this.age = age;
		this.price = price;
	...
	public String getManifactureDate() {
		return manifactureDate;
	}


	public void setManifactureDate(String manifactureDate) {
		this.manifactureDate = manifactureDate;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(age, color, manifactureDate, materials, name, price);
	}
	...
	public boolean equals(Object obj) {
		...
		return age == other.age && Objects.equals(color, other.color)
				&& Objects.equals(manifactureDate, other.manifactureDate) && Objects.equals(materials, other.materials)
				&& Objects.equals(name, other.name) && price == other.price;
	}
	
	/** 아래 toString() 에서 재료명 포기 시 사용함
	...
	public String toString() {
		return String.format("이름 : %s / 가격 : %d / 색상 : %s / 사용가능연령 : %d / 제조년월일 : %s / 재료 : %s",
								name, price, color, age, manifactureDate, getmaterialsAsString());
	}
