...
import edu.kh.poly.ex1.model.service.KKMCalculator;
import edu.kh.poly.ex2.model.service.AbstratService;

public class AbstratRun {

	public static void main(String[] args) {
		
		//new AbstratService().ex1();
		
		//new AbstratService().ex2();
