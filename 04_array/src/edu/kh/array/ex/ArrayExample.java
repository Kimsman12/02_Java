...
public class ArrayExample {
	...
	public void ex2() {
		...
		// arr[0~3] 전부 JVM에 의해 0으로 초기회 되어있는 상태
	...
	public void ex3() {
		...
		// height 에 heap 영역에 새로 생성된 double 5칸짜리 배열 주소를 대입
		...
		for(int i = 0; i < height.length; i++) {
			...
			sum += height[i]; // 배열의 각 index에 저장된 값을 누적
	...
	public void ex5() {
		...
		// jvm에 의해 int형 기본값인 0 으로 초기회 되어 있음.
	...
	public void ex9() {
		...
		/*
		 * ex) 문자열 입력 : hello [h, e, l, l, o] 검색할 문자 입력 : l 2개 있음
		 *
		 *
		 */
		...
		// sc.next() - > String 형
		// String.charAt(0) - > String의 0번째 인덱스 문자 하나를 추출해서
		// char형태로 반환한다
