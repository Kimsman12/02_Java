...
public class ArrayExample2 {
	...
	public void deepCopy() {
		...
		// 3. 복사할 배열 참조변수 = Array.copy0f(원본배열, 복사할 길이)
	...
	public void createLottoNumber() {
		...
		// 1) 정수 6개를 저장할 배열 선언 빛 할당
		int[] lotto = new int[6];
		
		// 생성된 배열을 처음부터 끝까지 순차접근하는 for문 작성
